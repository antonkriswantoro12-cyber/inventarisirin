export type EquipmentStatus = 'Baik' | 'Rusak Ringan' | 'Rusak Berat' | 'Dalam Perbaikan' | 'Dalam Kalibrasi' | 'Afkir';
...
export interface Room {
  ...
  code: string;
  name: string;
  headName: string; // Kepala Ruangan
  location: string;
  capacity: number;
  equipmentCount: number;
  conditionStatus: 'Sangat Baik' | 'Baik' | 'Perlu Pemeliharaan';
}
...
export interface UserRoleDefinition {
  id: string;
  name: string; // Super Administrator, Administrator, Kepala Instalasi IRIN, Teknisi Elektromedis, Kepala Ruangan, Petugas, Viewer
  description: string;
  permissions: string[];
  isCustom?: boolean;
}
