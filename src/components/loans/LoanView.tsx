...
import { Handshake, Plus, Clock, CheckCircle, AlertTriangle, FileSpreadsheet, Download, X } from 'lucide-react';
...
export const LoanView: React.FC<LoanViewProps> = ({ loans, equipment, onAddLoan, onReturnLoan }) => {
                  ...
                  <td className="py-3 px-4 text-center">
                    {item.status === 'Dipinjam' && (
                      <button
                        ...
                        className="px-3 py-1 bg-emerald-600 text-white font-bold rounded-lg text-[10px] hover:bg-emerald-700"
                      >
                        Proses Pengembalian
                      </button>
                    )}
