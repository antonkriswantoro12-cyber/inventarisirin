...
export const CorrectiveMaintenanceView: React.FC<CorrectiveViewProps> = ({
  ...
  const [editingRecord, setEditingRecord] = useState<CorrectiveMaintenanceRecord | null>(null);
  ...
  const handleOpenEdit = (record: CorrectiveMaintenanceRecord) => {
  ...
  const handleDelete = (id: string) => {
    if (window.confirm('Apakah Anda yakin ingin menghapus laporan kerusakan ini?')) {
